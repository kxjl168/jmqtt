...
<div class="col-lg-12 wzbj">
    ...
    <h5 style="margin-top: 12px;">
        首页&nbsp;><span style="color: #1cb09a;">&nbsp;平台日志管理</span>
    </h5>
</div>
...
<div class="col-lg-12" id="deviceQuery">
    ...
    <div class="deviceCriteria">
        <h3>消息类型</h3>
        <label>
            <select class="selectpicker" id="msg_type">
                <option value="Reserved">全部</option>
                <option value="CONNECT">CONNECT</option>
                <option value="PUBLISH">PUBLISH</option>
                <option value="ALARM">ALARM</option>
                <option value="OPENLOCK">OPENLOCK</option>
                <option value="REMOTEKEY">REMOTEKEY</option>
                <option value="CHECKSECRET">CHECKSECRET</option>
                <option value="SETSECRET">SETSECRET</option>
                <option value="CHECKKVP">CHECKKVP</option>
                <option value="SETKVP">SETKVP</option>
                <option value="CHECKALMCNT">CHECKALMCNT</option>
                <option value="SETALMCNT">SETALMCNT</option>
    ...
    <a class="button button-primary button-rounded button-small" onclick="lockQuery()" style="margin-top: 40px;">
...
<script src="/vendor/page/lock/js/cloudLog.js"></script>
