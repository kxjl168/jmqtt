...
<#--复选框样式-->
    <link href="${ctx}/vendor/util/skins/flat/blue.css" rel="stylesheet">
    <script src="${ctx}/vendor/util/js/icheck.min.js"></script>
<#--密码强度样式-->
...
<#--密码强度js-->
    <script src="${ctx}/vendor/password/js/pwdStrength.js" type="text/javascript"></script>
<#--邮箱域名提示-->
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">初始化管理员</h1>
    </div>
</div>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <form id="add_admin_form" action="/manager/admin/registerSubmit.action"
                              class="form-horizontal" role="form" method="POST" >
                            <div class="form-group">
                                <label for="account" class="col-lg-3 control-label">管理员账号</label>
                            ...
                            -->
                            <div class="form-group">
                                <label for="password" class="col-lg-3 control-label">管理密码</label>
                            ...
                            <div class="form-group">
                                <label for="confirm" class="col-lg-3 control-label">确认密码</label>
                            ...
                            <div class="form-group">
                                <label for="captchaCode" class="col-lg-3 control-label">验证码</label>

                                <div class="col-lg-4 input-group">
                                        <input type="text" name="captchaCode" class="form-control" id="captchaCode"
                                               placeholder="验证码">

                                    <span id="captcha" class="input-group-addon">
                                        <img src="${ctx}/validateCode.action" height="20" id="captcha_image"  />
                                    </span>
                            ...
                            <div  class="form-group">
                                <div id="errorMsg" class="col-lg-offset-3 col-lg-8" style="color: #f00;">
...
<script type="text/javascript" src="${ctx}/vendor/metisMenu/metisMenu.js"></script>
<script type="text/javascript" src="${ctx}/vendor/sbadmin/js/sb-admin-2.js"></script>
...
<script type="text/javascript">
    $(function () {
        ...
        var errMsg = '${errMsg!}';
        if(errMsg){
            $("#errorMsg").html(errMsg).show(300).delay(3000).hide(300);
        }
