...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">退款订单号-order表中orderNo:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">状态1：等待退款 ； 2：已完成:</label>

						<div class="col-xs-7">
							<input id="q_orderFlag" type="text" name="q_orderFlag"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">等待退款-退款扫描表列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">等待退款-退款扫描表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/ordertorefund/js/ordertorefund.js"></script>
</body>
</html>