...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">资源名称:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">属性1:</label>

						<div class="col-xs-7">
							<input id="q_attr1" type="text" name="q_attr1"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">测列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/ktest/js/ktest.js"></script>
</body>
</html>