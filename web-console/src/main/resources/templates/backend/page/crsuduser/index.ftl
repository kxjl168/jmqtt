	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">用户token值:</label>

						<div class="col-xs-7">
							<input id="q_userToken" type="text" name="q_userToken"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">用户表列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/crsuduser/js/crsuduser.js"></script>
</body>
</html>