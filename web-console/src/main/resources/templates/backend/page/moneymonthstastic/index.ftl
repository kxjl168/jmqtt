...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">月  2010-10:</label>

						<div class="col-xs-7">
							<input id="q_dayTime" type="text" name="q_dayTime"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">金额类型, 1:押金，2：消费，3:退款，4:充值:</label>

						<div class="col-xs-7">
							<input id="q_moneyType" type="text" name="q_moneyType"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">月统计列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/moneymonthstastic/js/moneymonthstastic.js"></script>
</body>
</html>