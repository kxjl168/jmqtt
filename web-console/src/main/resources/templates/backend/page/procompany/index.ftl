...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">公司名称:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">prokey:</label>

						<div class="col-xs-7">
							<input id="q_productKey" type="text" name="q_productKey"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">公司表列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/procompany/js/procompany.js"></script>
</body>
</html>