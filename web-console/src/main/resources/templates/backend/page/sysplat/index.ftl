...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">平台名称:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">平台根url:</label>

						<div class="col-xs-7">
							<input id="q_rootPath" type="text" name="q_rootPath"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">平台信息表列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">平台信息表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/sysplat/js/sysplat.js"></script>
</body>
</html>