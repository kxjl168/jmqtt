...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">创建用户id:</label>

						<div class="col-xs-7">
							<input id="q_createUserId" type="text" name="q_createUserId"
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">该规则的数据类型，取值：JSON和BINARY:</label>

						<div class="col-xs-7">
							<input id="q_dataType" type="text" name="q_dataType"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">规则列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/rule/js/rule.js"></script>
</body>
</html>