...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">节点名称:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">IP-PORT:</label>

						<div class="col-xs-7">
							<input id="q_ipPort" type="text" name="q_ipPort"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
				...
				<form class=" hide form-inline margin-top-10">
					 

					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">上下线 1：上线，0 :离线:</label>

						<div class="col-xs-7">
							<input id="q_status" type="text" name="q_status"
								class="form-control inputtxt" placeholder=""
								aria-controls="dataTables-example">
						</div>
					</div>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">mqtt节点信息表列表</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<span class="header">mqtt节点信息表列表</span>
					</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/mqttnode/js/mqttnode.js"></script>
</body>
</html>