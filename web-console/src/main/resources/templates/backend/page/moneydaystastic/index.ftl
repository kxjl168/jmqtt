...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">天  2010-10-02:</label>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">天统计列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/moneydaystastic/js/moneydaystastic.js"></script>
</body>
</html>