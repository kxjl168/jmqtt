...
<body>
	...
	<div class="modal-body">
		...
		<div class="queryclass">
				...
				<form class="form-inline">
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">用户id:</label>
					...
					<div class="form-group">
						<label for="name" class="lb_text col-xs-5 control-label">收货人:</label>
		...
		<div class="mainbody">
			<div class="row">
				<div class="col-xs-5" style="margin-top: 16px;">收货地址列表</div>
		...
		<script
			src="${ctx}/vendor/pageAuto/malldeliveryaddress/js/malldeliveryaddress.js"></script>
</body>
</html>